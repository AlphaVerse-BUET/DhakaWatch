...
const team = [
  {
    ...
    role: "GEE & Remote Sensing Lead",
    bio: "Designed spectral index classification pipeline (MNDWI, NDTI, CDOM) for pollution and encroachment detection. Built GEE processing workflows for Sentinel-2 and Landsat imagery. Developed SAR coherence-based erosion monitoring system.",
  ...
  },
  {
    ...
    bio: "Built React/Next.js dashboard with interactive Leaflet maps. Integrated Overpass API for real-time factory geolocation. Developed evidence submission system with Gemini Vision AI analysis. Implemented alert system and reporting pipeline.",
  ...
  },
  {
    ...
    bio: "Built data ingestion pipeline for processing satellite imagery and spectral indices. Compiled validation datasets for accuracy assessment. Managed evidence report data structures and research documentation.",
...
const technologies = [
  ...
  { name: "Leaflet Maps", desc: "Interactive map visualization", icon: Globe },
...
const capabilities = [
  ...
  },
  {
    ...
    description:
      "SAR coherence analysis detects bank retreat by comparing pre/post monsoon imagery",
    accuracy: "SAR-based",
  },
];
