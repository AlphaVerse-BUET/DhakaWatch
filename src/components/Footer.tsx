        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li>
                <Link href="/uhi-monitoring" className="hover:text-teal transition-colors">
                  Heat Map
                </Link>
              </li>
              <li>
                <Link href="/green-canopy-index" className="hover:text-teal transition-colors">
                  Vegetation
                </Link>
              </li>
              <li>
                <Link href="/evidence" className="hover:text-teal transition-colors">
                  Citizen Reports
                </Link>
              </li>
            </ul>
